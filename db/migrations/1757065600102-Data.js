module.exports = class Data1757065600102 {
    name = 'Data1757065600102'
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_2c7b2ffbd1f600a35f87317f7a"`)
        await db.query(`DROP TABLE "event_metadata"`)
        await db.query(`DROP INDEX "public"."IDX_0817c16131339484069f1af3cb"`)
        await db.query(`DROP INDEX "public"."IDX_e3d88724099f9665ad312a39f7"`)
        await db.query(`DROP TABLE "registration"`)
        await db.query(`DROP INDEX "public"."IDX_e273290b4292fe15ea3b0d0351"`)
        await db.query(`DROP TABLE "event_token"`)
        await db.query(`DROP INDEX "public"."IDX_f1e86d71aa04b69b2ec68a3d73"`)
        await db.query(`DROP TABLE "payment"`)
        await db.query(`DROP INDEX "public"."IDX_7e4a9d66fdf160a9fb9d236150"`)
        await db.query(`DROP INDEX "public"."IDX_dd7d291c180f33c6ed2b707c17"`)
        await db.query(`DROP INDEX "public"."IDX_78c29983ce0c63267ed64a8bf6"`)
        await db.query(`DROP TABLE "ticket"`)
        await db.query(`DROP INDEX "public"."IDX_902a22d2110174b48925314c87"`)
        await db.query(`DROP INDEX "public"."IDX_1b0d23f9b5adc281af44f382ef"`)
        await db.query(`DROP INDEX "public"."IDX_080fdcb740809a21228fccaf67"`)
        await db.query(`DROP TABLE "poap"`)
        await db.query(`DROP INDEX "public"."IDX_19b1c0c39337fd75ca73a5f251"`)
        await db.query(`DROP INDEX "public"."IDX_1d1de0ad1ac3dd184cb96c66ee"`)
        await db.query(`DROP INDEX "public"."IDX_2b2f68133725d9a7acf50e4870"`)
        await db.query(`DROP TABLE "event"`)
        await db.query(`DROP INDEX "public"."IDX_fe0840e4557d98ed53b0ae5146"`)
        await db.query(`DROP INDEX "public"."IDX_155aaa70119f077c016f931c8f"`)
        await db.query(`DROP INDEX "public"."IDX_f9e5249129bc322437853cf93f"`)
        await db.query(`DROP INDEX "public"."IDX_6d225d2181fcfcebdfd7ac5365"`)
        await db.query(`DROP INDEX "public"."IDX_fb931d7d954ab53421bbd19ad3"`)
        await db.query(`DROP INDEX "public"."IDX_f85a1ea6996d7e1d617425b90a"`)
